# 🧠 Summa — Resumos Inteligentes com Tecnologia Gemini
![summa](https://github.com/user-attachments/assets/6f5a56b3-be70-4911-b9f5-894493a0209c)

**Summa** é um software **open source** desenvolvido em **Python**, criado para gerar **resumos automáticos de vídeos do YouTube** com rapidez e precisão.  
...
Baixe o programa clicando no botão abaixo(Após realizar o download da pasta, execute o arquivo **main.exe**):  
